...
struct SearchFieldRow: View {
    ...
    var body: some View {
        HStack(spacing: 6) {
            // Emoji thay SF Symbol (đổi 2026-09-13) — mất khả năng đổi màu theo isFocused (emoji
            // không ăn .foregroundColor như SF Symbol), chấp nhận đánh đổi để đồng bộ phong cách.
